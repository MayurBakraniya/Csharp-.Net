...
namespace CoreWebApiPractice.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Course>>> searchbyname(string name)
        {
        ...
        //public async Task<ActionResult<IEnumerable<Course>>> searchbyduration(int duration)
        //{
